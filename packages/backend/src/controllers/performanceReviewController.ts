...
export const getPerformanceReviews = async (req: Request, res: Response) => {
  try {
    const performanceReviews = await PerformanceReviewService.getAllPerformanceReviews();
...
export const getPerformanceReview = async (req: Request, res: Response) => {
  ...
  try {
    const performanceReview = await PerformanceReviewService.getPerformanceReviewById(id);
